...
Require Import Coq.Setoids.Setoid.
 ...
 Qed. 
  ...
  Proof with auto.
    intros.
    split; intros; simpl in *; unfold union in *...
  ...
  Proof with auto.
    intros. split; intros; simpl in *; unfold join in *; unfold union in *; destruct H0.
    ...
    + destruct H0. destruct H0. remember H0 as H0'. clear HeqH0'.
      destruct H. eapply bool_true_spec in H0. subst. destruct H1.
      - left. trivial.
      - destruct H2. eapply bool_true_spec in H0.  subst. left. trivial. trivial.
      - trivial.
  ...
  Proof with auto.
    ...
    + inversion H. apply IHe1 in H2. apply IHe2 in H3. clear IHe1 IHe2. 
      subst. simpl in *. unfold join.
       ...
       - right. unfold not. intros. destruct H2 as [z [H2 H3]].
         remember H3 as H3'. clear HeqH3'. apply bool_true_spec in H3.
         subst. contradiction.
         inversion H. trivial.
       - right. unfold not. intros. destruct H2 as [z [H2 H3]].
         remember H2 as H2'. clear HeqH2'. apply bool_true_spec in H2. 
         subst. contradiction.
         inversion H. trivial.
    ...
    + unfold inv. inversion H. apply IHe in H1. clear IHe. subst. destruct H1. 
