...
(* OASIS_START *)
(* DO NOT EDIT (digest: b76ddcaa309a77e25dae0c8d71088f0f) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the netkat.quickcheck library";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["NetKAT_ONF"; "NetKAT_Syntax"; "NetKAT_Semantics"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\1817\031t|>\014\160\239ct\226l\169\020K";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
